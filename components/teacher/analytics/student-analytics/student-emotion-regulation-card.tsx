          ...
          >
            ...
            <View className="flex-1 flex-col gap-1.5">
              ...
              <Text className={`font-quicksand-medium text-[#484A4B] leading-relaxed ${isTablet ? 'text-xs' : 'text-[11px]'}`}>
                • <Text className="font-quicksand-bold text-[#62A9E6]">Readiness-to-Learn Zones:</Text> Logs daily classroom check-in routines and emotional regulation states before and during activities.
              </Text>
              <Text className={`font-quicksand-medium text-[#484A4B] leading-relaxed ${isTablet ? 'text-xs' : 'text-[11px]'}`}>
                • <Text className="font-quicksand-bold text-[#62A9E6]">Trigger & Strategy Insights:</Text> Identifies environmental factors and calming strategies that help the learner transition smoothly.
              </Text>
              <Text className={`font-quicksand-medium text-[#484A4B] leading-relaxed ${isTablet ? 'text-xs' : 'text-[11px]'}`}>
                • <Text className="font-quicksand-bold text-[#62A9E6]">Navigation:</Text> Swipe horizontally or use the weekly toggle to view past weeks' emotional regulation logs.
              </Text>
            </View>
          </Animated.View>
        )}
