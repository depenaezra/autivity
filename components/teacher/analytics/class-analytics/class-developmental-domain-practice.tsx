...
export default function ClassDevelopmentalDomainPractice({ classId, filter: externalFilter }: ClassDevelopmentalDomainPracticeProps) {
                    ...
                    <View className="flex-row items-center gap-2 mt-2.5 ml-6 flex-wrap">
                      {domain.masterDomain === lowestExposureDomainName && (
                        <View className="bg-[#FFF3C4] border border-[#FFAE02] px-2.5 py-0.5 rounded-full">
                          <Text className="font-fredoka-one text-[10px] text-[#D97706] uppercase">
                            FOCUS NEEDED
                          </Text>
                        </View>
                      )}
