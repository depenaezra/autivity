...
export default function StudentDevelopmentalSkillsHeatmap({ studentId }: StudentDevelopmentalSkillsHeatmapProps) {
    ...
    useEffect(() => {
        async function loadData() {
            ...
            try {
                ...
                console.error('StudentDevelopmentalSkillsHeatmap: failed to load exposure data', err);
            ...
            {isLoading ? (
                ...
                <View className="w-full justify-center items-center py-12 px-6 border-2 border-dashed border-[#E5E7EB] rounded-xl bg-[#F9FAFB]">
                    ...
                    <Text className="font-quicksand-medium text-sm text-[#9CA3AF] mt-1 text-center">
                        This student has not completed any activities matching this timeframe.
                    </Text>
                </View>
            ) : (
