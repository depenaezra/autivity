        ...
        <View className="px-6">
          ...
          <View className={isTablet ? "mt-8" : "mt-6"}>
            <View className="flex-row items-center justify-between mb-3">
              <Text className={`text-[#6B7280] font-quicksand-semibold tracking-widest ${isTablet ? "text-base" : "text-sm"
                }`}
              >
                PROFILE
              </Text>
              ...
              >
                ...
                <Text
                  className={`text-[#0284C7] font-quicksand-bold ml-2 ${isTablet ? "text-base" : "text-sm"
                    }`}
                >
                  {isEditing ? "Done" : "Edit"}
                </Text>
            ...
            <View className={`bg-white rounded-[20px] shadow-sm border border-[#F3F4F6] ${isTablet ? 'p-6' : 'p-4'}`}>
              ...
              <View className={`flex-row items-center border-b border-[#F3F4F6] ${isTablet ? 'pb-4 mb-4' : 'pb-3 mb-3'}`}>
                <Text
                  className={`font-quicksand-medium text-[#4B5563] ${isTablet ? 'w-[120px] text-lg' : 'w-[90px] text-sm'
                    }`}
                >
                  Name
                </Text>
                ...
                {isEditing ? (
                  ...
                  <Text
                    className={`font-quicksand-medium flex-1 text-[#9CA3AF] ${isTablet ? 'text-lg' : 'text-sm'
                      }`}
                  >
                    {firstName} {lastName}
                  </Text>
